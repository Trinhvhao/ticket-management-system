  ...
  if (!canCreate) {
    return (
      <div className="text-center py-20">
        ...
        <p className="text-gray-500">Bạn không có quyền tạo bài viết.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Tạo Bài viết</h1>
          <p className="text-gray-500">Thêm bài viết mới vào kho kiến thức</p>
        </div>
      </div>
