...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary: 'bg-[#0052CC] text-white hover:bg-blue-700 focus:ring-[#0052CC] shadow-sm',
      secondary: 'bg-gray-100 text-gray-900 hover:bg-gray-200 focus:ring-gray-500',
      outline: 'border-2 border-gray-300 text-gray-700 hover:border-[#0052CC] hover:text-[#0052CC] focus:ring-[#0052CC]',
